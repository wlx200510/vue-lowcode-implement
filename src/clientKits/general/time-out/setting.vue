<template>
  <div>
    <el-dialog
      ...
      :visible.sync="timeoutClickShow"
      @close="timeoutClickShow = false"
      width="780px"
    >
      <el-row>
          ...
          <div class="area-container" v-if="areas.length" id="timesMap">
            ...
            >
              <div class="crop-box-content">
                <span class="crop-box-text" :style="getFontStyle(areas[0])">{{
                  counts.day
                }}</span>
              </div>
            ...
            >
              <div class="crop-box-content">
                <span class="crop-box-text" :style="getFontStyle(areas[1])">{{
                  areas[0].show ? counts.hour : counts.all_hour
                }}</span>
              </div>
            ...
            >
              <div class="crop-box-content">
                <span class="crop-box-text" :style="getFontStyle(areas[2])">{{
                  areas[1].show ? counts.minute : counts.all_minute
                }}</span>
              </div>
            ...
            >
              <div class="crop-box-content">
                <span
                  ...
                  >{{ areas[2].show ? counts.second : counts.all_second }}.{{
                    counts.millisecond
                  }}</span
                >
                <span
                  ...
                  v-else
                  :style="getFontStyle(areas[3])"
                  >{{ areas[2].show ? counts.second : counts.all_second }}</span
                >
              </div>
  ...
  watch: {
    ...
    times: {
      handler(val) {
        ...
        if (!val[0].show && !val[1].show && !val[2].show && !val[3].show) {
